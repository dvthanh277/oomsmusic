                ...
                <div className='player-playlist'>
                    ...
                    <div className='playlist-song'>
                        {listPlay.map((props, index) => (
                            <div
                                className={`song ${context.song.encodeId === props.encodeId ? `active` : ``}`}
                                key={index}
                            >
                                {/* {!props.isWorldWide ? <div className='isWorldWide'><p className='textNoti'>Nội dung này không tải được cho quốc gia của bạn!</p></div> : ``} */}
                                {props.streamingStatus === 2 ? (
                                    <div className='vip-song'>
                                        <img src='../../images/vip.png' alt='vip-song'></img>
                                        <span>VIP Song</span>
                                    </div>
                                ) : !props.isWorldWide ? (
                                    <div className='isWorldWide'>
                                        <img src='../../images/location.png' alt='location-song'></img>
                                        <span>Nội dung này không tải được cho quốc gia của bạn!</span>
                                    </div>
                                ) : (
                                    ``
                                )}
                                <div className='song-head'>
                                    ...
                                    <img
                                        ...
                                        src={props.thumbnail}
                                        alt={props.title}
                                        onClick={() => context.handleClickSong(props)}
                                    ></img>
                                    <div className='title-wrapper'>
                                        <p
                                            onClick={() => context.handleClickSong(props)}
                                            className={`song-title ${
                                                context.song.encodeId === props.encodeId ? `active` : ``
                                            }`}
                                            title={props.title}
                                        >
                                            {props.title}
                                        ...
                                        <p className='song-singer'>
                                            {props.artists?.map((item, index) => (
                                                <Link to={'/artist/' + item.alias} key={index} state={item.alias}>
                                                    {item.name}
                                                    {index + 1 === props.artists.length ? '' : ' ,  '}{' '}
                                                </Link>
                                            ))}{' '}
                                        </p>
                                    </div>
                ...
                <div className='player-playing'>
                    ...
                    <div className='player-progress'>
                        <input
                            ...
                            min='0'
                            max={song.duration}
                            value={hmsToSeconds(currentTime)}
