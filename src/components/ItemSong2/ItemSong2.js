    ...
    return (
        <div className="ooms-item-song2">
            ...
            {context.song.encodeId === props.encodeId
                ...
                : <button onClick={() => context.handleClickSong(props)} className="song-play"><span className="ooms-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
