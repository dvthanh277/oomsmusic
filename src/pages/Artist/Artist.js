                ...
                <div className='ooms-artist'>
                    <div className='artist-info'>
                        ...
                        <div className='artist-text'>
                            ...
                            <p className='info'>
                                <>{data.sortBiography.replaceAll('<br>', '\n')}</>
                            </p>
                        </div>
                    </div>
                    <div className='artist-section'>
                        <div className='artist-song'>
                            <h2 className='ooms-title-head'>
                                {dataSong.title}
                                <Link to={'/songs' + data.link} state={data.id} className='ooms-view-more'>
                                    Xem tất cả
                                </Link>
                            </h2>
                        ...
                        {dataPlaylist.map((item, index) => (
                            <div className='artist-album' key={index}>
                                <h2 className='ooms-title-head'>{item.title}</h2>
